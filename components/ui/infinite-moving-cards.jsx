    ...
    <div className="flex flex-col items-center">
      ...
      >
        ...
        >
          {items.map((item) => (
            <li
  className="relative w-[300px] sm:w-[320px] md:w-[450px] max-w-full shrink-0 rounded-2xl border border-b-0 border-zinc-200 
             bg-[linear-gradient(180deg,#fafafa,#f5f5f5)] px-6 py-4 md:px-8 md:py-6
...
>
      ...
      {contentWidth > 0 && (
        <input
          ...
          className="mt-4 px-4 w-full max-w-md custom-slider"
        />
      )}
    </div>
  );

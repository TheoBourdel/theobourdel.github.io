  ...
  return (
      <div className="px-4 py-10 md:py-20">
        <h1
          ...
          {"Votre événement, notre expertise musicale."
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        <motion.p
          ...
          DJ professionnel pour mariages et soirées inoubliables. Une expérience musicale personnalisée du cocktail jusqu’à la dernière danse.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
